...
public class ItemSameShovel extends ItemSpade {

	private OCmaterialType Mateliatype;
	private OCMaterial Matelia;

	public ItemSameShovel(OCMaterial materoal ,OCmaterialType materialtype) {
		super(materoal.getToolmatelia(), materoal.getShovelDamege()-3f, materoal.getShovelSpeed()-4, (new Item.Properties()).group(OCItemGroups.OCTAB));
