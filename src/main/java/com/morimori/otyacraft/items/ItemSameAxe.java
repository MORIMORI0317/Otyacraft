...
public class ItemSameAxe extends ItemAxe {

	private OCmaterialType Mateliatype;
	private OCMaterial Matelia;

	public ItemSameAxe(OCMaterial materoal ,OCmaterialType materialtype) {
		super(materoal.getToolmatelia(), materoal.getAxeDamege()-3, materoal.getAxeSpeed()-4, (new Item.Properties()).group(OCItemGroups.OCTAB));
